layui.define(['laytpl', 'upload', 'url_format', 'table'], function (exports) {
    var obj = {
        ...
        initUploadTable: function (element, uploadList) {
            ...
            //同步渲染产品表格
            layui.table.render({
                elem: '#' + element + '_table', data: uploadList, cols: [[
        ...
        inArray: function (str, ary, fld) {
            if (fld) {
                ...
                if (typeof (str) != 'string' || !Array.isArray(ary)) return false;
        ...
        getLog: function (type_flag, case_id, list_box) {
            var that = this;
            var tab1 = layui.table.render({
                elem: list_box, url: that.urlData['provebill'], cols: layui.log_cols['table_cols'],
        ...
        isEmpty: function (obj) {
            if (typeof obj == "undefined" || obj == null || obj == "" || obj == 0 || obj == {}) {
                return true;
            } else {
                return false;
            }
